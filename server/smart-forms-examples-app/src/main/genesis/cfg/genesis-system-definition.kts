systemDefinition {
    global {
        ...
        item(name = "DbHost", value = "jdbc:h2:file:~/genesis-local-db/smart-forms-examples/h2/test;DB_CLOSE_DELAY=-1;NON_KEYWORDS=VALUE,KEY;AUTO_SERVER=TRUE")
        item(name = "DbQuotedIdentifiers", value = true)
        item(name = "DEPLOYED_PRODUCT", value = "smart-forms-examples")
    ...
    systems {
        ...
        system(name = "DEV") {
            ...
            item(name = "DbNamespace", value = "smart-forms-examples")
